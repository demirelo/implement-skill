...
become the **immutable oracle**. Plan-approval is **off** — the human is not consulted here (the only
Phase-1 human interaction would be touchpoint #2, the final merge, which is Phase 5).
