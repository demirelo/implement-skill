    ...
    return (
        {
            ...
            "credentials": {},
            "prefs": {"effort": "low", "max_tokens": 32000, "temperature": 0.0},
        },
        FakeRun(),
    )
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="implement-smoke-") as tmp:
        ...
        # A smoke command is itself a health check. Never report success when the fixture was not
        # demonstrably red before the Builder turn, green after it, and backed by an applied winner.
        healthy = (
            before.returncode != 0
            and bool(best.winner)
            and best.applied is True
